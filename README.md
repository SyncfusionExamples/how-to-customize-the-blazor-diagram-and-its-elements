...
A quick start Blazor project that shows how to customize the diagram canvas page in the [Blazor Diagram](https://www.syncfusion.com/blazor-components/blazor-diagram) Component. This project includes a code snippet to display page breaks and multiple pages in the canvas. It also includes a code snippet to customize the position and appearance of nodes and connectors and bridge connectors.
